...
export default function Generator( props) {
  ...
  return (
    ...
    >
        ...
        {Object.keys(WORKOUTS).map((type, typeIndex) => {
          return (
            <button
              ...
              className={
                "bg-slate-950 border rounded-lg py-3 px-4 duration-200 hover:border-blue-600 " +
      ...
      />
      <div className="bg-slate-950  border border-solid border-blue-400 rounded-lg flex flex-col duration-200 hover:border-blue-600">
        <button
          onClick={toggleModal}
      ...
      <Button name={'Formulate'} click = {updateWorkout} />
    </SectionWrapper>
  );
}
