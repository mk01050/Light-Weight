  ...
  return (
    <div className='p-4 rounded-md flex flex-col bg-slate-950 sm:flex-wrap'>
        <div className='flex flex-col sm:flex-row sm:items-center sm:flex-wrap gap-x-4 '  >
            <h4 className='hidden text-3xl sm:inline sm:text-4xl md:tet-5xl font-semibold text-slate-400'> 0{i+1}</h4>
        ...
        <div className='grid grid-cols-2 sm:grid-cols-4 sm:items-center gap-2'>
            {['reps','rest','tempo'].map(info=>{
                return(
                    <div key={info} className='flex flex-col p-2 rounded border-[1.5px] bordr-solid border-slate-900 w-full '>
            ...
            <button onClick={handleSetIncrement} className='flex flex-col p-2 rounded border-[1.5px] duration-200 border-solid border-blue-900 hover:border-blue-600 w-full  '>
                <h3 className='text-slate-400 text-sm capitaliez'> Sets Completed</h3>
